...
from .forms import LoginForm,MyPasswordResetForm,MyPasswordChangeForm,MySetPasswordForm,CustomPasswordResetForm


# basic django file url paths
...
path('add-to-cart/', views.add_to_cart, name="add-to-cart"), path('cart/', views.show_cart, name="showcart"),
...
# login authentication relate codes
...
path(
  ...
  path(
    ...
    auth_view.PasswordResetConfirmView.as_view(
        template_name='app/password_reset_confirm.html',
        form_class=MySetPasswordForm  # Ensures the new password is set
    ),
...
# admin panel change codes


admin.site.site_header = "Red Back"
admin.site.site_title = "Red Back"
admin.site.site_index_title = "Welcome to the Red Back"