...
SECRET_KEY = 'django-insecure-l!&ma1o8df!eu2p69cpc6wmiqdn02iqgx@3quzl1+ck@t1ct@f'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "giridharanredbackit@gmail.com"  # Used to send emails
EMAIL_HOST_PASSWORD = "lmpajuxldqsifwta"  # Use App Password for better security
